...
QtObject {
    ...
    readonly property double settingsHFactor: isMobile ? 0.4 : 0.3
    readonly property double settingsWFactor: isMobile ? 0.75 : 0.5
    readonly property double busyIndicatorFactor: isMobile ? 0.12 : 0.08
    readonly property double playPauseFactor: isMobile ? 0.2 : 0.08
